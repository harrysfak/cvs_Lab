...
# Βασικά paths
BASE_PATH = r"C:/Users/mpamp/Υπολογιστής/code/git/cvs_Lab8/csv_lab12.2.26/cvs_Lab-new-after"

# output folder μέσα στο project (ασφαλές default)
OUTPUT_PATH = r"C:/Users/mpamp/Υπολογιστής/code/git/cvs_Lab8/csv_lab12.2.26/cvs_Lab-new-after"
